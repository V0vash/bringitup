...
window.addEventListener('DOMContentLoaded', function () {
  var mainSlider = new _modules_slider_sliderMain__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next'
  });
  mainSlider.render();
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_sliderMini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  feedSlider.init();
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.page .play', '.overlay').init();
...
/* harmony import */ var _services_wrapQ__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/wrapQ */ "./src/js/modules/services/wrapQ.js");
...
function () {
  ...
  _createClass(Difference, [{
    ...
    value: function bindTriggers(container, items, counter) {
      Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_1__["$$"])('.plus', container).addEventListener('click', function () {
...
/* harmony import */ var _services_wrapQ__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/wrapQ */ "./src/js/modules/services/wrapQ.js");
...
function () {
  ...
  _createClass(Forms, [{
    ...
    value: function createStatusMessage(form) {
      var statusMassage = document.createElement('div');
      statusMassage.classList.add('status');
      form.append(statusMassage);
      return Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_7__["$$"])('.status');
    }
  }, {
    key: "checkEmailInput",
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          var status = _this.createStatusMessage(item);

          var formData = new FormData(item);
          status.textContent = _this.message.loading;

          _this.postData(_this.url, formData).then(function (res) {
            console.log(res);
            status.textContent = _this.message.success;
          }).catch(function () {
            console.log('error');
            status.textContent = _this.message.failure;
          }).finally(function () {
            _this.clearInputs();
...
/* harmony import */ var _services_wrapQ__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/wrapQ */ "./src/js/modules/services/wrapQ.js");
...
function () {
  function VideoPlayer(triggers, popup) {
    ...
    this.btns = Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])(triggers);
    this.overlay = Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])(popup);
    this.close = Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])('.close', this.overlay);
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(state) {
      try {
        ...
        var playBtn = Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])('svg', this.activeBtn).cloneNode(true);

        if (state.data === 0) {
          if (Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])('.play__circle', blockedElem).classList.contains('closed')) {
            Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])('.play__circle', blockedElem).classList.remove('closed');
            Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])('svg', blockedElem).remove();
            Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])('.play__circle', blockedElem).appendChild(playBtn);
            Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])('.play__text', blockedElem).textContent = 'play video';
            Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_2__["$$"])('.play__text', blockedElem).classList.remove('attention');
...
/***/ "./src/js/modules/services/wrapQ.js":
/*!******************************************!*\
  !*** ./src/js/modules/services/wrapQ.js ***!
  \******************************************/
/*! exports provided: $$ */
...
/* harmony import */ var _services_wrapQ__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/wrapQ */ "./src/js/modules/services/wrapQ.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/* harmony import */ var _services_wrapQ__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/wrapQ */ "./src/js/modules/services/wrapQ.js");
...
/* harmony import */ var _services_wrapQ__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/wrapQ */ "./src/js/modules/services/wrapQ.js");
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        ...
        if (_this.animate) {
          Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_12__["$$"])('.card__title', slide).style.opacity = '0.4';
          Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_12__["$$"])('.card__controls-arrow', slide).style.opacity = '0';
        }
      });
      this.slides[0].classList.add(this.activeClass);

      if (this.animate) {
        Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_12__["$$"])('.card__title', this.slides[0]).style.opacity = '1';
        Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_12__["$$"])('.card__controls-arrow', this.slides[0]).style.opacity = '1';
      }
    }
  }, {
    key: "skipBtns",
    ...
    value: function activateAutoplay(delay) {
      var _this3 = this;
      ...
      if (this.autoplay == true) {
        ...
        var stopTriggers = [this.next, this.prev].concat(_toConsumableArray(this.slides));
        stopTriggers.forEach(function (slide) {

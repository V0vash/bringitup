  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        ...
        if (_this.animate) {
          Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_9__["$$"])('.card__title', slide).style.opacity = '0.4';
          Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_9__["$$"])('.card__controls-arrow', slide).style.opacity = '0';
        }
      });
      this.slides[0].classList.add(this.activeClass);

      if (this.animate) {
        Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_9__["$$"])('.card__title', this.slides[0]).style.opacity = '1';
        Object(_services_wrapQ__WEBPACK_IMPORTED_MODULE_9__["$$"])('.card__controls-arrow', this.slides[0]).style.opacity = '1';
      }
    }
  }, {
    key: "bindTriggers",
